...
class ActorsMovieResponse {
    ...
    factory ActorsMovieResponse.fromRawJson(String str) => ActorsMovieResponse.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory ActorsMovieResponse.fromJson(Map<String, dynamic> json) => ActorsMovieResponse(
        id: json["id"],
